...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝确认发货接口快速通道</span>
		</div>
        ...
        <form name=alipayment action=alipayapi.php method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDlogistics_name" />
                        <span>必填</span>
                    </dd>
                    <dt>物流发货单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDinvoice_no" />
                        <span></span>
                    </dd>
                    <dt>物流运输类型：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDtransport_type" />
                        <span>三个值可选：POST（平邮）、EXPRESS（快递）、EMS（EMS）</span>
                    </dd>
					<dt></dt>
                    <dd>
